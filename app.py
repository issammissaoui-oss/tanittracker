...
def on_message(ws, message):
    ...
    try:
        ...
        if msg_type == "SubscriptionConfirmation":
            ...
            print("[AIS] Abonnement validé par aisstream.io.", flush=True)
            return
...
def on_close(ws, close_status_code, close_msg):
    ...
    print("Connexion WebSocket fermée, tentative de reconnexion...", flush=True)
...
def run_ais_stream():
    def on_open(ws):
        ...
        print("Abonnement envoyé pour le C/F TANIT.", flush=True)
