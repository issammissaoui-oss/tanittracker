...
# Données de voyage et position par défaut du C/F TANIT
ship_state = {
    "name": "C/F TANIT",
...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        /* Panneau supérieur style "Compagnie aérienne" */
        #top-banner {
...
<body>
    ...
    <div id="top-banner">
        <div class="ship-title">
            <h1>🚢 C/F TANIT</h1>
            <p id="route-text">Chargement de l'itinéraire...</p>
        </div>
        <div id="status-badge" style="font-size: 12px; background: rgba(16, 185, 129, 0.2); color: #34d399; padding: 5px 10px; border-radius: 20px; border: 1px solid rgba(16, 185, 129, 0.4);">
            En direct
        </div>
    </div>
    ...
    <script>
        // Initialisation de la carte avec un fond sombre élégant style aviation/marine
        var map = L.map('map', { zoomControl: false }).setView([36.8170, 10.3050], 12);
