...
ship_data = {
    "mmsi": TANIT_MMSI,
    "name": "C/F TANIT",
    "latitude": 36.8170,  # Position par défaut (La Goulette)
    "longitude": 10.3050,
    "speed": 0.0,
    "course": 0.0,
...
def on_message(ws, message):
    ...
    try:
        ...
        if msg_type == "SubscriptionConfirmation":
            ship_data["status"] = "Connecté (Recherche du C/F TANIT...)"
            return
...
def run_ais_stream():
    def on_open(ws):
        # ABONNEMENT CIBLÉ GLOBAL : Uniquement sur le MMSI du C/F TANIT sans restriction de boîte
        sub = {
            "APIKey": AIS_API_KEY,
        ...
        print("Abonnement envoyé pour le MMSI:", TANIT_MMSI)
