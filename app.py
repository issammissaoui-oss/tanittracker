...
# Initialisation avec la position réelle observée au port de La Goulette
ship_data = {
    "mmsi": TANIT_MMSI,
    "name": "C/F TANIT",
    "latitude": 36.8122,  
    ...
    "speed": 0.0,
    "course": 0.0,
    "timestamp": "Position validée (Port de La Goulette)",
    "packets": 0,
    "status": "Mode synchro actif (En attente de trame radio)"
}
    ...
    try:
        ...
        if TANIT_MMSI in mmsi_str or "TANIT" in ship_name:
            ...
            if lat is not None and lon is not None:
                ...
                ship_data["packets"] += 1
                ship_data["status"] = "En direct (Flux AIS Live)"
